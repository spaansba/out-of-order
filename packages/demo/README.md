...
Interactive demo. Two pages, both thin consumers of [`@focuspocus/reveal`](../reveal). The overlay comes entirely from the library, so this could be rebuilt in React, Vue, or anything else without changing the core.
