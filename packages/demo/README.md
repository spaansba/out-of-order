...
**Docs** (static, no JS, same spec-sheet styling): `index.html` (home), `getting-started.html`, `rules.html`, `api.html`, `faq.html`. All pages share `src/styles.css` and the same top bar.
